...
%%%%%%%%%%%%%%% GitHub %%%%%%%%%%%%%%%
\newcommand{\github}[2]{
    \info{\href{#1}{\underline{#2}}}{github-square}
}
...
%%%%%%%%%%%%%%% Kaggle %%%%%%%%%%%%%%%
\newcommand{\kaggle}[2]{
    \info{\href{#1}{\underline{#2}}}{kaggle}
}

\newcommand{\infocirc}[1]{
    \info{#1}{circle-info}
}
...
\newcommand{\education}[4]{
    ...
    % School Name 
    \large
    \noindent \color{gray} \parbox{.7\linewidth}{\textsl{#3}} \par
    % Description
    \normalsize \color{black}
    \vspace*{0.3em}
    \small #4 
...
\newcommand{\work}[4]{
    ...
    \noindent \large \color{gray} \parbox{.7\linewidth}{\textsl{#3}} \par
