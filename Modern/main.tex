    ...
    \begin{minipage}[t]{0.7\textwidth} % Main Panel (e.g. Education, Work Experience)
        \begin{tcolorbox}[grow to right by=0.75cm,height=0.8\textheight,colframe=white,colback=white]
            ...
            \work{Data Scientist}{OCt 2021 - Sept 2022}{Accenture}{
                ...
                \begin{itemize}
                    \item Exploratory Data Analysis: Worked with diverse data available to prepare and train predictive models to help gain 
                    information.
                    \item Collaboration on an automatic Data Anonymization System
                \end{itemize}
            }
            ...
            \education{BSc in Mathematical Engineering on Data Science}{Sep 2018 - Mar 2023}{Universitat Pompeu Fabra}{
                ...
                \begin{itemize}
                    ...
                    \item Data Visualization (Power Bi)
                \end{itemize}
            ...
            \section*{Tools}
                GitHub, Pytorch,  OpenCV, Seaborn Matplotlib, Keras,\\
                Tensorflow, Google Collab, Linux Terminal, MySQL, Google Sheets\\
                Power Bi, Excel
        \end{tcolorbox}
    \end{minipage}
\end{tcolorbox}
